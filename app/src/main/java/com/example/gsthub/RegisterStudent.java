...
public class RegisterStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        branch = findViewById(R.id.studentBranch);
        team = findViewById(R.id.studentTeam);
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(editTeam.isEmpty())
                {
                    email.setError("Please enter your team if any or else put null!");
                    email.requestFocus();
                }
                ...
                {
                    Toast.makeText(RegisterStudent.this,"All the fields are empty!",Toast.LENGTH_SHORT).show();
                }

                else if(!(editEmail.isEmpty() && editPass.isEmpty()))
                {
                    auth.createUserWithEmailAndPassword(editEmail,editPass).addOnCompleteListener(RegisterStudent.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful())
                            {
                                Toast.makeText(RegisterStudent.this,"You have been Registered Successfully!",Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(getApplicationContext(), SignInAs.class);
                                startActivity(intent);
                            }
                            else
                            {
                                Toast.makeText(RegisterStudent.this,"Something went Wrong! Please try again!",Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                ...
                {
                    Toast.makeText(RegisterStudent.this,"Error Occurred!",Toast.LENGTH_LONG).show();
                }
